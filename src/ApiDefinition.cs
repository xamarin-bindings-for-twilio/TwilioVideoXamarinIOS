...
namespace Twilio.Video.iOS
{
	...
	interface TVIVideoFrame
	{
		...
		IntPtr Constructor (CMTime timestamp, CVImageBuffer imageBuffer, TVIVideoOrientation orientation);
		...
		IntPtr Constructor (double timeInterval, CVImageBuffer imageBuffer, TVIVideoOrientation orientation);
...
*/[Introduced (PlatformName.iOS, 11, 0)]
	...
	{
		// extern NS_SWIFT_NAME(AppScreenSource.ErrorDomain) NSErrorDomain kTVIAppScreenSourceErrorDomain __attribute__((availability(ios, introduced=11.0))) __attribute__((swift_name("AppScreenSource.ErrorDomain")));
		[Introduced (PlatformName.iOS, 11, 0)]
	...
	[Introduced (PlatformName.iOS, 11, 0)]
	[BaseType (typeof(NSObject))]
	interface TVIAppScreenSource : TVIVideoSource
	{
...
*/[Introduced (PlatformName.iOS, 11, 0)]
	...
	partial interface Constants
	{
		// extern NS_SWIFT_NAME(CameraSource.ErrorDomain) NSString *const kTVICameraSourceErrorDomain __attribute__((availability(ios, introduced=11.0))) __attribute__((swift_name("CameraSource.ErrorDomain")));
		[Introduced (PlatformName.iOS, 11, 0)]
	...
	interface TVIConnectOptionsBuilder_CallKit
	{
		...
		[Export ("setUuid:", ArgumentSemantic.Strong)]
	...
	partial interface Constants
	{
		// extern NS_SWIFT_NAME(TwilioVideoSDK.ErrorDomain) NSErrorDomain kTVIErrorDomain __attribute__((availability(ios, introduced=11.0))) __attribute__((swift_name("TwilioVideoSDK.ErrorDomain")));
		[Introduced (PlatformName.iOS, 11, 0)]
	...
	interface TVIRemoteParticipantDelegate
	{
		...
		void RemoteParticipantDidChangePublishPriority (TVIRemoteParticipant participant, string priority, TVIRemoteAudioTrackPublication publication);
