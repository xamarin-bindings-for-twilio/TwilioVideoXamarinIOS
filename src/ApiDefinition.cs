...
namespace Twilio.Video.iOS
{
	...
	{
		// extern NSErrorDomain  _Nonnull const kTVIAppScreenSourceErrorDomain __attribute__((swift_name("AppScreenSource.ErrorDomain")));
	...
	partial interface Constants
	{
		// extern NSErrorDomain  _Nonnull const kTVIErrorDomain __attribute__((swift_name("TwilioVideoSDK.ErrorDomain")));
